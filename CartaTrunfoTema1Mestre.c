...
int main() {
    ...
    vencedor = (populacao > populacao2) ? "Carta 1" : "Carta 2"; 
    ...
    vencedor = (area > area2) ? "Carta 1" : "Carta 2";
    ...
    resultado =  (pib > pib2);
    vencedor = (pib > pib2) ? "Carta 1" : "Carta 2";
    ...
    vencedor = (n_turisticos > n_turisticos2) ? "Carta 1" : "Carta 2";
    ...
    vencedor = (dens_populacional < dens_populacional2) ? "Carta 1" : "Carta 2";
    ...
    vencedor = (pib_capita > pib_capita2) ? "Carta 1 " : "Carta 2";
    ...
    vencedor =  (poder > poder2) ? "Carta 1" : "Carta 2";
